...
# Demonstrates low latency with eventual consistency
...
echo "=========================================="
echo "  ASYNC Example - Primary-First KV Store"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "  Testing ASYNC Mode (Primary-First)"
echo "=========================================="
echo ""
...
echo "  # Write (fast - returns immediately)"
